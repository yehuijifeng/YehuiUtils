...
import com.yehui.utils.contacts.ImageContact;
...
public class PhotoViewActivity extends BaseActivity implements
    ...
    protected String setTitleText() {
        return "photoView查看图片";
    }

    @Override
    protected void initView() {
        imgUrls.add(ImageContact.images[6]);
        imgUrls.add(ImageContact.images[7]);
        imgUrls.add(ImageContact.images[2]);
        imgUrls.add(ImageContact.images[3]);
        imgUrls.add(ImageContact.images[8]);
        position = 0;
