...
public class SatisfactionActivity extends BaseEaseActivity {
	...
	private TextView nick_service=null;
	@Override
	...
	private void initView() {
		...
		nick_service= (TextView) findViewById(R.id.nick_service);
		nick_service.setText(Constant.DEFAULT_COSTOMER_ACCOUNT);
