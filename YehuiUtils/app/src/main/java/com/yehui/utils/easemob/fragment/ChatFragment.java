...
import com.yehui.utils.easemob.activity.ContextMenuActivity;
import com.yehui.utils.easemob.chatrow.ChatRowEvaluation;
import com.yehui.utils.easemob.chatrow.ChatRowRobotMenu;
...
//		pointToAgentUser(message, "ceshia@qq.com");
	...
	public void onMessageBubbleLongClick(EMMessage message) {
		// 消息框长按
		startActivityForResult((new Intent(this.getActivity(), ContextMenuActivity.class)).putExtra("message", message),
	...
	private void setUserInfoAttribute(EMMessage message) {
		...
		try {
			...
			visitorJson.put("qq", Constant.DEFAULT_MSG);
			visitorJson.put("phone", currentUserNick);
			visitorJson.put("companyName", Constant.DEFAULT_MSG);
			visitorJson.put("description", "");
			visitorJson.put("email", Constant.DEFAULT_MSG);
