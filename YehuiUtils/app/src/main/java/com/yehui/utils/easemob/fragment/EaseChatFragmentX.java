package com.yehui.utils.easemob.fragment;
...
import com.alsfox.chatlibrary.widget.EaseChatExtendPrompt;
import com.alsfox.chatlibrary.widget.EaseChatInputMenuX;
...
public class EaseChatFragmentX extends EaseBaseFragment implements EMEventListener{
	...
	protected static final String TAG = EaseChatFragmentX.class.getSimpleName();
	...
	static final int PROMPT_ITEM_FAHUO = 1;
	static final int PROMPT_ITEM_TEXT_WEIGHT = 2;
	static final int PROMPT_ITEM_TEXT_COLOR = 3;
	static final int PROMPT_ITEM_TEXT_KUAIDI = 4;
	protected int[] promptItemStrings = {R.string.text_weight,R.string.text_fahuo, R.string.text_kuaidi , R.string.text_color};
	protected int[] promptItemIds = { PROMPT_ITEM_FAHUO, PROMPT_ITEM_TEXT_WEIGHT, PROMPT_ITEM_TEXT_COLOR, PROMPT_ITEM_TEXT_KUAIDI };
	
    private boolean isMessageListInited;
    protected MyMenuItemClickListener extendMenuItemClickListener;
    protected MyPromptItemClickListener extendPromptItemClickListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.easex_fragment_chat, container, false);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
		...
		//判断是默认，还是用技能组（售前、售后）
        messageToIndex = Constant.MESSAGE_TO_DEFAULT;
...
//        }
    ...
    protected void initView() {
        ...
        extendPromptItemClickListener = new MyPromptItemClickListener();
        inputMenu = (EaseChatInputMenuX) getView().findViewById(R.id.input_menu);
        registerExtendMenuItem();
        registerExtendPromptItem();
        
        // init input menu
        inputMenu.init();
        inputMenu.setChatInputMenuListener(new EaseChatInputMenuX.ChatInputMenuListener() {
        ...
        // 如果不使用常用语，设置这句即可
//        inputMenu.setPromptEnable(false);
    ...
    protected void setUpView() {
        ...
        if (chatType == EaseConstant.CHATTYPE_SINGLE) { // 单聊
            ...
            titleBar.setLeftImageResource(com.easemob.easeui.R.drawable.ic_menu_back);
        }
    ...
    /**
     * 注册常用语菜单扩展栏item, 覆盖此方法时如果不覆盖已有item，item的id需大于4
     */
    protected void registerExtendPromptItem(){
    	for(int i = 0; i< promptItemStrings.length; i++){
    		inputMenu.registerExtendPromptItem(promptItemStrings[i], promptItemIds[i], extendPromptItemClickListener);
    	}
    }
    ...
    protected void onMessageListInit(){
        ...
        messageList.getListView().setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                hideKeyboard();
                inputMenu.hideExtendAllContainer();
                return false;
            }
        });
     ...
     *
     */
    class MyPromptItemClickListener implements EaseChatExtendPrompt.EaseChatExtendPromptItemClickListener {

		@Override
		public void onClick(int itemId, View view) {
			if(chatFragmentListener != null){
                if(chatFragmentListener.onExtendPromptItemClick(itemId, view)){
                    return;
                }
            }
			inputMenu.setInputMessage(promptItemStrings[itemId - 1]);
		}
    ...
    public interface EaseChatFragmentListener{
        ...
        /**
         * 扩展输入栏item点击事件,如果要覆盖EaseChatFragmentX已有的点击事件，return true
         * @param view 
         * @param itemId 
         * @return
         */
        ...
        /**
         * 常用语点击事件，如果覆盖EaseChatFragmentX已有的点击事件，return true
         * @param itemId
         * @param view
         * @return
         */
        boolean onExtendPromptItemClick(int itemId, View view);
