...
public abstract class EaseChatPrimaryMenuBaseX extends RelativeLayout {
	...
	protected EaseChatPrimaryMenuListenerX listener;
	protected Activity activity;
	protected InputMethodManager inputManager;

	public EaseChatPrimaryMenuBaseX(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}

	public EaseChatPrimaryMenuBaseX(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	 ...
	 * @param listener
	 */
	public void setChatPrimaryMenuListener(EaseChatPrimaryMenuListenerX listener) {
	...
	public interface EaseChatPrimaryMenuListenerX {
		/**
		 * 发送按钮点击事件
		 * 
		 * @param content
		...
		/**
		 * 显示或隐藏扩展prompt按钮的点击事件
		 */
		void onToggleExtendPromptClicked();
