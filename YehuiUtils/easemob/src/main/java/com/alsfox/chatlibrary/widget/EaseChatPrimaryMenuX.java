 ...
 * 
 */
public class EaseChatPrimaryMenuX extends EaseChatPrimaryMenuBaseX implements OnClickListener {
	...
	public EaseChatPrimaryMenuX(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context, attrs);
	}

	public EaseChatPrimaryMenuX(Context context, AttributeSet attrs) {
	...
	private void init(final Context context, AttributeSet attrs) {
		...
		buttonPrompt = (Button) findViewById(R.id.btn_prompt);
	...
	public void setPromptEnable(boolean enable){
		if(enable){
			buttonPrompt.setVisibility(View.VISIBLE);
		}else{
	...
	public void onClick(View view) {
		...
		if (id == R.id.btn_send) {
			...
			showNormalFaceImage();
			if(listener != null){
				listener.onToggleExtendPromptClicked();
			}
