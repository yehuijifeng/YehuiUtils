...
public class EaseEmojiconScrollTabBar extends RelativeLayout{
    ...
    public void addTab(int icon){
        ...
        LinearLayout.LayoutParams imgParams = new LinearLayout.LayoutParams(DensityUtil.dip2px(context, tabWidth), android.view.ViewGroup.LayoutParams.MATCH_PARENT);
