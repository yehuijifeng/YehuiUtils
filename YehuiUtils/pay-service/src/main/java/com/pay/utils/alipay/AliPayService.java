...
public class AliPayService {
    ...
    public static  String BACK_ASYNC_URL;
    ...
    public void setBckAsyncRul(final String PARTNER,final String SELLER,String RSA_PRIVATE,final String BACK_ASYNC_URL){
        this.PARTNER=PARTNER;
        this.SELLER=SELLER;
        this.RSA_PRIVATE=RSA_PRIVATE;
        this.BACK_ASYNC_URL=BACK_ASYNC_URL;
    }
